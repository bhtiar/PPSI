            ...
            <div class="w3-container" style="padding-bottom:10px">
              <form action="cari_filter.php" method="get">
                ...
                <div style="padding-top:10px;">
                  <button type="submit" name="filter" class="w3-btn w3-theme-d1 w3-margin-bottom"><i
          ...
          while ($r = mysqli_fetch_array($sql)) {
            ...
            <div class="w3-container w3-card-2 w3-white w3-round" style="margin-left: 10px; margin-top:10px;"><br>
              ...
              <div class="w3-row-padding" style="margin:0 -16px">
                <div class="w3-half">
                  <img src="operator/assets/foto_lap/<?php echo $r['foto']; ?>" style="width:100%; min-height:100%;"
                ...
                <form action="transaksi.php" method="post">
                  ...
                  <div class="w3-half">
                    ...
                    <?php echo $r['nama_futsal']; ?><br><br>
                    <i class="fa fa-location-arrow" aria-hidden="true"></i>&nbsp;
                    <?php echo $r['alamat_futsal']; ?><br><br>
                    <i class="fa fa-list-alt" aria-hidden="true"></i> Studio &nbsp;
                    <?php echo $r['no_lap']; ?><br><br>
                    <i class="fa fa-life-ring" aria-hidden="true"></i> Lapangan
                    <?php echo $r['jenis_rumput']; ?><br><br>
                    <i class="fa fa-tags" aria-hidden="true"></i> Rp.
                    <?php echo $r['harga']; ?> per jam<br><br><br><br>
                  </div>
                  <div class="w3-right">

                    <button type="submit" class="w3-btn w3-teal w3-margin-bottom"><i class="glyphicon glyphicon-book"></i>
                      Pesan</button>
                </form>
              </div>
            </div>
