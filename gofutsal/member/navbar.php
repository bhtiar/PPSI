    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav">
          <li class="w3-hide-small"><a href="#" class="w3-padding-large w3-hover-white" title="Home"><i
                class="fa fa-home"></i></a></li>
          <li class="w3-hide-small"><a href="#" class="w3-padding-large w3-hover-white" title="Account Settings"><i
                class="fa fa-user"></i></a></li>
          <li class="w3-hide-small"><a href="#" class="w3-padding-large w3-hover-white" title="Riwayat Pesan"><i
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="w3-hide-small"><a href="../jadwal.php" class="w3-padding-large w3-hover-white" title="Rent"><i
                class="fa fa-calendar-check-o"></i></a></li>
          <li class="w3-hide-small"><a href="member_profil.php" class="w3-padding-large w3-hover-white"
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="w3-hide-small w3-dropdown-hover">
            <a href="#" class="w3-padding-large w3-hover-white"><img
                src="assets/foto_member/<?php echo $sql_sel['foto']; ?>" class="w3-circle" style="height:25px;width:25px"
                alt="Avatar">&nbsp;&nbsp;Hi,
