...
<!-- about section -->
    ...
    <div class="swiper hero-slider">
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide slide">
          <div class="content">
            <span>Ade Sound System Studio</span>
            <h3>HARMONIKAN BAKATMU
              BERSAMA KAMI DI ASS STUDIO.</h3>

          </div>
          <div class="image">
            <img src="assets/images/band.png" alt="">
          </div>
        </div>
  ...
  <section class="about">
    ...
    <div class="tentang">
      <h1> Tentang Kami</h1>
      <p>Di ASS Studio, kami memahami betapa pentingnya musik dalam kehidupan seseorang. Oleh karena itu, kami
        menyediakan fasilitas dan instruktur musik berkualitas tinggi untuk membantu siswa kami memperoleh kemampuan
        musik yang luar biasa.
        Selain itu, kami juga menawarkan kursus musik untuk berbagai jenis instrumen dan level kemampuan, mulai dari
        pemula hingga mahir. Instruktur kami yang terampil dan berdedikasi akan membantu siswa kami mencapai potensi
        musik mereka.Kami bangga menjadi bagian dari perjalanan musik Anda dan berharap dapat membantu Anda meraih
        kesuksesan dalam karir musik atau menikmati musik sebagai hobi. Terima kasih telah memilih ASS Studio sebagai
        mitra musik Anda.</p>
    </div>
  </section>
     ...
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
         ...
         <div class="carousel-inner" role="listbox">
           <div class="item active">
             <img src="assets/futsal/1.jpeg" alt="Image">
           ...
           <div class="item">
             <img src="assets/futsal/2.jpeg" alt="Image">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/futsal/3.jpeg" alt="Image">
             <div class="carousel-caption">
