      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" name="modal_popup" action="opt_pro_bayar.php" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <div class="col-sm-8">
               <input type="text" class="form-control" name="id_book" placeholder="Kode Studio" value="<?php echo $sql_res['id_book']; ?>" readonly>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-4" for="email">Jumlah Harga</label>
            <div class="col-sm-8">
               <input type="text" class="form-control" name="jumlah_harga" placeholder="Kode Studio" value="<?php echo $sql_res['total_harga']; ?>" readonly>
            </div>
          </div>
          <div class="form-group">
