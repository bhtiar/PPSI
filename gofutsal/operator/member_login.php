    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-sm-9"><button type="submit" class="btn btn-success" data-toggle="modal" data-target="#Modal2"
              data-dismiss="modal"><span class="glyphicon glyphicon-user"></span>&nbsp; Operator</button></h5>
          </div>
        </div>
        <br>
        <div class="form-group">
          <div class="col-sm-offset-3 col-sm-9">
            <p>
              Atau masuk dengan akun ASS-Studio Anda
            </p>
          </div>
        </div>
        <form class="form-horizontal" action="" method="post">
          ...
          <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9">
              <button type="submit" class="btn btn-primary" name="loginmember"><span
