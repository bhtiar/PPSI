  ...
  <div class="container">
    ...
    <form class="form-horizontal" action="opt_pro_reg.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3"></div>
        <div class="col-sm-8">
          <a href="../member/member_daftar.php">
            <h4><b>Anda Ingin Mendaftar Sebagai Member?</b></h4>
          </a>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <label class="btn btn-info" for="my-file-selector2">
            <input id="my-file-selector2" name="foto" required type="file" style="display:none;"
      ...
      <div class="form-group">
        ...
        <div class="checkbox col-sm-8">
          <label><input type="checkbox" name="aturan" value="">
            <h5><b>Saya mengerti dan menyetujui dengan aturan pengguna yang berlaku</b></h5>
          </label>
        </div>
      </div>
