  ...
  <body>
    ...
    if (isset($_GET['lap'])) {
      if ($_GET['lap'] == "delete") {
        ...
        mysqli_query($koneksi, "delete from lapangan where id_lap = '$_GET[id_lap]'") or die(mysqli_error($koneksi));
    ...
    <div class="container-fluid w3-content" style="max-width:1400px;margin-top:60px">
      ...
      <div id="Modalharga" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">

      </div>
      <!-- Modal Popup untuk bayar offline-->
      <div id="Modalbayar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        ...
        <div class="w3-col m3">
          ...
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container">
              <br>
              <p class="w3-center"><img src="assets/foto_opt/<?php echo $sql_sel['foto']; ?>" class="w3-circle"
                  style="height:106px;width:106px" alt="Avatar"></p> <br>
              <h4 class="w3-center">
                <?php echo $sql_sel['nama_opt']; ?>
              </h4>
              <hr>
          ...
          <div class="w3-card-2 w3-round">
            <div class="w3-accordion w3-white">
              <button onclick="myFunction('Demo1')" class="w3-btn-block w3-theme-l1 w3-left-align"><i
                  class="fa fa-circle-o-notch fa-fw w3-margin-right"></i> Data </button>
              ...
              <button onclick="myFunction('Demo2')" class="w3-btn-block w3-theme-l1 w3-left-align"><i
                  class="fa fa-calendar-check-o fa-fw w3-margin-right"></i> Pemesanan</button>
              ...
              <button onclick="myFunction('Demo3')" class="w3-btn-block w3-theme-l1 w3-left-align"><i
                  class="fa fa-tags fa-fw w3-margin-right"></i> Pembayaran</button>
              ...
              <button onclick="myFunction('Demo4')" class="w3-btn-block w3-theme-l1 w3-left-align"><i
                  class="fa fa-users fa-fw w3-margin-right"></i> Foto</button>
                ...
                <div class="w3-row-padding" style="margin:0 -16px">
                  ...
                  <form class="form-horizontal form-label-left" method="post">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kode Booking <span
                          class="required"></span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="first-name" name="id_book" required="required"
                          class="form-control col-md-7 col-xs-12" value="<?php echo $nextID; ?>" readonly>

                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nama Pemesan <span
                          class="required"></span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="nama" required="required" class="form-control col-md-7 col-xs-12" value="">
                        <input type="hidden" name="kode" required="required" class="form-control col-md-7 col-xs-12"
                          value="<?php echo $nextID2; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">No Lapangan<span
                          class="required"></span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="hidden" id="id_lap1" name="id_lap1" required="required"
                          class="form-control col-md-7 col-xs-12" readonly>
                        <input type="hidden" id="username1" name="username1" required="required"
                          class="form-control col-md-7 col-xs-12" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Jenis Lapangan<span
                          class="required"></span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="jenis_rumput1" name="jenis_rumput1" required="required"
                          class="form-control col-md-7 col-xs-12" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Harga Per Jam<span
                          class="required"></span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="harga1" name="harga1" required="required"
                          class="form-control col-md-7 col-xs-12" readonly>
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Tanggal Main<span
                          class="required"></span>
                      </label>
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Durasi<span
                          class="required"></span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Total Harga<span
                          class="required"></span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="total" name="total_harga" required="required"
                          class="form-control col-md-7 col-xs-12" value="0" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <button type="submit" class="btn btn-success" name="lanjut">Lanjutkan <i
        ...
        <div class="w3-row-padding" style="margin:0 -16px">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              Tabel Lapangan&nbsp;<a class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal"><span
                  ...
                  <tbody>
                    ...
                    while ($sql_res = mysqli_fetch_array($query_sel)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <?php echo $sql_res['id_lap']; ?>
                        </td>
                        <td>
                          <?php echo $sql_res['no_lap']; ?>
                        </td>
                        <td>
                          <?php echo $sql_res['jenis_rumput']; ?>
                        </td>
                        <td class="center">
                          <?php
                        ...
                        <td class="center">
                          <a href="#" class='open_modal btn btn-primary btn-xs' id='<?php echo $sql_res['id_lap']; ?>'><span
                              class="glyphicon glyphicon-edit"></span> Edit</a>&nbsp
                          <a href="#" onClick="confirm_modal('lap_pro_del.php?&id_lap=<?php echo $sql_res['id_lap']; ?>');"
