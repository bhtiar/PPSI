    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
          ...
          $nextID = "ST" . sprintf("%03s", $nextNoUrut);
          ?>
          <div class="form-group">
            <label class="control-label col-sm-4" for="email">Kode Studio</label>
            <div class="col-sm-8">
              <input type="text" readonly="readonly" value="<?php echo $nextID; ?>" class="form-control" name="id_lap"
                id="pwd" placeholder="Kode Studio" required>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-4" for="email">Jenis</label>
            <div class="col-sm-8">
              <select class="form-control" name="jenis_rumput" required>
                <option disabled="disabled">--- Pilih ---</option>
                <option value="sintetis">Sudio Musik</option>
          ...
          <div class="form-group">
            <label class="control-label col-sm-4" for="email">Nama Studio</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" id="pwd" name="no_lap" placeholder="Nama Studio">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <label class="btn btn-info" for="my-file-selector2">
                <input id="my-file-selector2" name="foto" type="file" style="display:none;"
                  onchange="$('#upload-file-foto').html($(this).val());">
                Upload
              </label>
