...
<div class="modal-dialog modal-md">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <form class="form-horizontal" name="modal_popup" action="lap_pro_edit.php" method="post"
        enctype="multipart/form-data">
        <div class="form-group">
          <label class="control-label col-sm-4" for="email">Kode Studio</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" name="id_lap" id="id_lap" placeholder="Kode Studio"
              value="<?php echo $sql_res['id_lap']; ?>" readonly>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <select class="form-control" name="jenis_rumput">
              ...
              <option value="sintetis" <?php if ($sql_res['jenis_rumput'] == "sintetis") {
                echo "selected";
              } ?>>Sintetis
              </option>
              <option value="beton/semen" <?php if ($sql_res['jenis_rumput'] == "beton/semen") {
                echo "selected";
              } ?>>
                Beton/Semen</option>
            </select>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" name="harga" id="pwd" placeholder="Harga"
              value="<?php echo $sql_res['harga']; ?>">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <label class="btn btn-info" for="my-file-selectoredit">
              <input id="my-file-selectoredit" name="foto" type="file" style="display:none;"
                onchange="$('#upload-file-foto-edit').html($(this).val());">
              Upload
            </label>
