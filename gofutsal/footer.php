...
<footer class="container footer-distributed">
	...
	<div class="footer-left">
		...
		<h3><img src="assets/images/logo-gitar.png" width="50px" height="50px" />&nbsp;ASS-<span>Studio</span></h3>
		...
		<p class="footer-company-name">ASS-Studio &copy; 2016 | Repost by <a href="https://stokcoding.com/" title="StokCoding.com" target="_blank">StokCoding.com</a></p>
	</div>
	...
	<div class="footer-right">
		...
		if (isset($_POST['kirim'])) { //ketika tombol kirim ditekan maka akan menjalankan code bagian ini
			...
			$email = "bahtiarhasan33@gmail.com"; //email penerima
			$to = $email;  //email penerima
			$subject = "Kritik Dan Saran dari $nama"; //subject pesan pada email

			//sender
			$sender = "bahtiarhasan33@gmail.com"; //email pengirim
			$password = "ecmmlybuiebvduph"; //password email pengirim
