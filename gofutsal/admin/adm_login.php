...
<head>
  ...
  <title>Login Administration | ASS-Studio</title>
        ...
        <section class="login_content">
          <form action="" method="post">
            ...
            <div class="separator">
              ...
              <div>
                <h1><img src="../assets/images/Goputsalgaji.png" style="width:25px; height:25px;"> GO-<font color="#6fcb44">Studio</font>
                </h1>
                <p>GO Futsal By ASS-Studiom</p>
